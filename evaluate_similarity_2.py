...
def evaluate_datasets(test, result_2):
    """
    ...
    for test_idx, result_idx in pairs:
        if test_idx < len(test) and result_idx < len(result_2):
            ...
            predicted_tokens = result_2['Relevant_Documents_Tokenized'].iloc[result_idx]
            ...
            if recall < 0.9:
                bad_cases.append({
                    ...
                    'Predicted Text': result_2['Relevant_Documents_Tokenized'].iloc[result_idx]
                })
...
def es2(test_file, result_file, output_file):
    """
